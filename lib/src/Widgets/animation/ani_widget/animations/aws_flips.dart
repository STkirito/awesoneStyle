...
class AwsFlipInX extends StatefulWidget {
  final Widget child;
  ...
  @override
  _AwsFlipInXState createState() => _AwsFlipInXState();
}

/// State class, where the magic happens
class _AwsFlipInXState extends State<AwsFlipInX>
...
/// [controller]: opcional/obligatorio, expone el controlador de animación
/// el controlador se puede usar para repetir, invertir y lo que quieras, es solo un controlador de animación
class AwsFlipInY extends StatefulWidget {
  final Widget child;
  final Duration duration;
  final Duration delay;
  final Function(AnimationController)? controller;
  ...
  @override
  _AwsFlipInYState createState() => _AwsFlipInYState();
}

/// State class, where the magic happens
class _AwsFlipInYState extends State<AwsFlipInY>
    with SingleTickerProviderStateMixin {
  AnimationController? controller;
  bool disposed = false;
  late Animation<double> rotation;
