...
import 'package:awesonestyle/src/MotionTabItem.dart';
            ...
            child: Align(
              ...
              child: FractionallySizedBox(
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    SizedBox(
                      height: Medidas.heigth(widget.tabSize! + 30),
                      width: Medidas.width(widget.tabSize! + 30),
                      child: ClipRect(
                        clipper: HalfClipper(),
                        child: Container(
                          child: Center(
                            child: Container(
                              width: Medidas.width(widget.tabSize! + 10),
                              height: Medidas.heigth(widget.tabSize! + 10),
                              decoration: BoxDecoration(
                                color: widget.tabBarColor,
                    ...
                    SizedBox(
                      height: Medidas.heigth(widget.tabSize! + 15),
                      width: Medidas.width(widget.tabSize! + 35),
                      child: CustomPaint(
                          painter: HalfPainter(color: widget.tabBarColor)),
                    ),
                    SizedBox(
                      height: Medidas.heigth(widget.tabSize),
                      width: Medidas.width(widget.tabSize),
                      child: Container(
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
